...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    first_upsampling = tf.layers.conv2d_transpose(layer7_conv_1x1, num_classes, 4, 2,padding = 'same',
                                kernel_regularizer= tf.contrib.layers.l2_regularizer(1e-3)  )
    
    layer4_conv_1x1 = tf.layers.conv2d(vgg_layer4_out, num_classes, 1, padding = 'same',
                                kernel_regularizer= tf.contrib.layers.l2_regularizer(1e-3) )
    
    first_skip = tf.add(first_upsampling, layer4_conv_1x1)
    ...
    second_skip = tf.add(second_upsampling, layer3_conv_1x1)
    
    third_upsampling = tf.layers.conv2d_transpose(second_skip, num_classes, 16, 8,padding = 'same',
                                kernel_regularizer= tf.contrib.layers.l2_regularizer(1e-3)  )
    
    return third_upsampling
